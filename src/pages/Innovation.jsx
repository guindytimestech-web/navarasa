    ...
    <main className="min-h-screen bg-gray-50"> {/* Light gray background */}
        ...
        <PageWrapper>
          <ContentCard className="border-t-4 border-[#B30000]">
            {/* Added a wrapper div for responsive padding */}
            <div className="p-6 md:p-8">
              {/* Article Header */}
              <div className="mb-6 pb-4 border-b border-gray-200">
                <h1 className={`text-2xl sm:text-3xl font-extrabold mb-2 text-[#B30000]`} style={{ fontFamily: 'Montserrat, sans-serif' }}>
                  {article.title}
                </h1>
              ...
              <blockquote className={`border-l-4 border-[#B30000] pl-4 italic text-base sm:text-lg text-gray-800 font-semibold my-6 py-2 bg-red-50 rounded-r-md`}>
              ...
              {/* Article Content */}
              {/* The 'prose' classes handle responsiveness for this block */}
              <div
